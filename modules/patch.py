...
def sdxl_encode_adm_patched(self, **kwargs):
    ...
    if kwargs.get("prompt_type", "") == "negative":
        width = float(width) * patch_settings.negative_adm_scale
        height = float(height) * patch_settings.negative_adm_scale
    elif kwargs.get("prompt_type", "") == "positive":
        width = float(width) * patch_settings.positive_adm_scale
        height = float(height) * patch_settings.positive_adm_scale
